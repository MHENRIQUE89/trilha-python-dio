...
app = FastAPI(
    ...
    version="1.0.0",
    summary="Microsserviço para manter operações de saque e depósito em contas correntes.",
    description="""
Transactions API é o microsserviço para registrar transações de contas correntes. 💸💰
